                ...
                <AutoSizer>
                    {({width: _width, height: _height}) => (
                        <Table
                            ...
                            headerClassName={headerClassName || core.headerClassName}
                            ...
                            {columns.map(({hidden, useDynamicHeight, useDynamicWidth, cellRenderer, ...columnProps}, index) => {
                                ...
                                return (
                                    <Column
                                        key={index}
                                        className={cellClassName || core.cellClassName}
                                        {...Object.assign({}, 
                                            columnProps,
                                                ...
                                                cellRenderer: (args) => {
                                                    ...
                                                    return (
                                                        <CellMeasurer
                                                            ...
                                                            columnIndex={0}>
                                                            {!cellRenderer
                                                                ? <div className={cellClassName || core.cellClassName}> {args.cellData} </div>
